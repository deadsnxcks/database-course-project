...
func (h *Handler) List() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		render.JSON(w, r, dto.OperationsFromProto(resp.GetOperations()))
	}
}
...
func (h *Handler) Get() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		render.JSON(w, r, dto.OperationFromProto(resp.GetOperation()))
	}
}
...
func (h *Handler) Create() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := h.client.Create(ctx, &operationv1.CreateRequest{Title: req.Title})
		if err != nil {
			response.GRPCError(w, r, log, err)
...
func (h *Handler) Delete() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if _, err := h.client.Delete(ctx, &operationv1.DeleteRequest{Id: id}); err != nil {
			response.GRPCError(w, r, log, err)
