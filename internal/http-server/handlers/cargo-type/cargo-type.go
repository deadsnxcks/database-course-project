...
func (h *Handler) List() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		defer cancel()
		resp, err := h.client.ListCargoTypes(ctx, &cargotypev1.ListCargoTypesRequest{})
		if err != nil {
...
func (h *Handler) Create() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		grpcReq := &cargotypev1.CreateCargoTypeRequest{
			Title:       req.Title,
			ProcessCost: req.ProcessCost,
		}

		resp, err := h.client.CreateCargoType(ctx, grpcReq)
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
...
func (h *Handler) Get() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := h.client.GetCargoType(ctx, &cargotypev1.GetCargoTypeRequest{
			Id: id,
		})
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
...
func (h *Handler) Update() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		grpcReq := &cargotypev1.UpdateCargoTypeRequest{
			Id:          id,
			Title:       req.Title,
			ProcessCost: req.ProcessCost,
		}
		_, err = h.client.UpdateCargoType(ctx, grpcReq)
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
			st, ok := status.FromError(err)
			if !ok {
...
func (h *Handler) Delete() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_, err = h.client.DeleteCargoType(ctx, &cargotypev1.DeleteCargoTypeRequest{Id: id})
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
			st, ok := status.FromError(err)
			if !ok {
