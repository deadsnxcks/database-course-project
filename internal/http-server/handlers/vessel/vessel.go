...
func (h *Handler) List() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := h.client.ListVessels(ctx, &vesselv1.ListVesselsRequest{})
		if err != nil {
...
func (h *Handler) Create() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		grpcReq := &vesselv1.CreateVesselRequest{
			Title:      req.Title,
			VesselType: req.VesselType,
			MaxLoad:    req.MaxLoad,
		}

		resp, err := h.client.CreateVessel(ctx, grpcReq)
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
...
func (h *Handler) Get() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := h.client.GetVessel(ctx, &vesselv1.GetVesselRequest{Id: id})
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
			st, ok := status.FromError(err)
			if !ok {
...
func (h *Handler) Update() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		grpcReq := &vesselv1.UpdateVesselRequest{
			Id:         id,
			Title:      req.Title,
			VesselType: req.VesselType,
		}
		...
		_, err = h.client.UpdateVessel(ctx, grpcReq)
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
			st, ok := status.FromError(err)
			if !ok {
...
func (h *Handler) Delete() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_, err = h.client.DeleteVessel(ctx, &vesselv1.DeleteVesselRequest{Id: id})
		if err != nil {
			log.Error("grpc call failed", sl.Err(err))
			st, ok := status.FromError(err)
			if !ok {
